...
$total=number_format($stats["open"])+$stats["answered"]+$stats["overdue"];
    $nav->addSubMenu(array('desc'=>__('All Tickets').' ('.$total.')',
                           'title'=>__('All Tickets'),
                           'href'=>'tickets.php?status=alls',
                           'iconclass'=>'Ticket'),
                        ($_REQUEST['status']=='alls'));
