...
var scp_prep = function() {
    ...
    $('#cannedRespTask').change(function() {
        ...
        var $url = 'ajax.php/kb/canned-response/'+cid+'.json';
        if (tid)
            $url =  'ajax.php/tasks/'+tid+'/canned-resp/'+cid+'.json';
